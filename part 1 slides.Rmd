...
- National Data Buoy Center, Historical data of Station 46035 from 1988 to 2017

## Time Series of Air Teperature 
```{r}
library(tidyverse)
library(stringr)
...
## Correlation between Air and Sea Temperature
```{r}
...
## Test Air Temperature Changing (Sampling Data)
Ho:E(Temperature of Air in 1988) = E(Temperature of Air in 2017)
```{r}
...
## Test Sea Temperature Changing (Sampling Dta)
Ho:E(Temperature of Sea in 1988) = E(Temperature of Sea in 2017)
```{r}
...
## Test Air Temperature Changing (Whole Data)
```{r}
...
## Test Sea Temperature Changing (Whole Data)
```{r}
